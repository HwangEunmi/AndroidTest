...
public class CActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTvShortKey = (TextView) findViewById(R.id.tv_short_key);
         ...
         /*Toast 띄우는 메소드*/
        Utils.getmInstance().setFloatingToast(CActivity.this);

        setDataContent();

        /*바로가기 버튼클릭시 해당 url창을 띄움(mShortKey 필요)*/
                    ...
                    if ("true".equals(request.mIsSuccess)) { // 성공한 경우
                        ...
                        if (request.mImgPath0 != null) {
                            ...
                            Glide.with(CActivity.this)
                                    .load(Constant.DEFAULT_SOS_URL + request.mImgPath0)
                                    .into(mIvOneURL);
                        } else {
                            return null;
                        }
                        ...
                        if (request.mImgPath1 != null) {
                            ...
                            Glide.with(CActivity.this)
                                    .load(Constant.DEFAULT_SOS_URL + request.mImgPath1)
                                    .into(mIvTwoURL);
                        } else {
                            return null;
                        }
                        ...
                        if (request.mImgPath2 != null) {
                            ...
                            Glide.with(CActivity.this)
                                    .load(Constant.DEFAULT_SOS_URL + request.mImgPath2)
                                    .into(mIvThreeURL);
                        } else {
                            return null;
                        }
            ...
            public BaseData onFail(BaseData data) {
                if (data != null) {
                    ...
                    if ("false".equals(request.mIsSuccess)) { // 실패한 경우
                        if (request != null) {
                            Toast.makeText(CActivity.this, String.valueOf(request.mMessage), Toast.LENGTH_SHORT).show();
